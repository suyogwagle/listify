...
import { BGS, formatDate, PRIOTITYSTYLES, TASK_TYPE} from "../utils/index.js"
    ...
    <>
     <div className='w-full h-fit bg-white shadow-md p-4 rounded'>
      ...
      <div className="flex items-center gap-2 ">
        <div className={clsx("w-4 h-4 rounded-full", TASK_TYPE[tasks.stage])}></div>
